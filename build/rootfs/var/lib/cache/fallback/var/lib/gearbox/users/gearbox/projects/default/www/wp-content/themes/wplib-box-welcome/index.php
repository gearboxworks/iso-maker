    ...
    <div id="outer">
        ...
        <div id="content">
            ...
            <ul>
                ...
                <!--
                <li><a href="#" target="_blank">Change</a> the <a href="http://gearbox.local" target="_blank">gearbox.local</a> domain name to one for your project.</li>
            ...
            <ul>
                ...
                <li><a href="http://adminer.gearbox.local?server=172.18.0.1&username=wordpress&db=wordpress" target="_blank">Explore</a> the WordPress' MySQL database using Adminer</li>
                <li><a href="http://mailhog.gearbox.local" target="_blank">View</a> password reset and other emails in MailHog <em>(if any)</em></li>
                <li><a href="http://docs.gearbox.local" target="_blank">See MkDocs</a> in action, for documenting your plugin or theme</li>
                <!--
